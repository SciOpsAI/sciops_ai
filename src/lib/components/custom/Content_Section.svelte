<div class="relative isolate overflow-hidden px-6 py-5 sm:py-5 lg:overflow-visible lg:px-0">
	...
	<div class="w-full mx-auto grid max-w-7xl grid-cols-1 gap-x-8 px-8">
		<div class="pr-4">
				...
				<div class="grid grid-cols-2 gap-x-4 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 lg:gap-x-6">
				  <figcaption class="mt-6 flex flex-col items-center justify-center space-y-3">
					...
					<div class="flex flex-col items-center divide-y-2 divide-gray-500 dark:divide-gray-700">
					  <div class="pt-3 font-medium">Rui Melo</div>
					</div>
				  </figcaption>
	  
				  <figcaption class="mt-6 flex flex-col items-center justify-center space-y-3">
					<img class="h-24 w-24 rounded-full" src="/authors/vitor.png" />
					<div class="flex flex-col items-center divide-y-2 divide-gray-500 dark:divide-gray-700">
					  <div class="pt-3 font-medium">Vítor</div>
					</div>
				  </figcaption>
				  ...
				  <figcaption class="mt-6 flex flex-col items-center justify-center space-y-3">
					...
					<div class="flex flex-col items-center divide-y-2 divide-gray-500 dark:divide-gray-700">
					  <div class="pt-3 font-medium">Researcher</div>
					</div>
				  </figcaption>
